      ...
      <header className="border-b border-white/10 bg-background/95 backdrop-blur sticky top-0 z-50">
        <div className="container mx-auto max-w-6xl px-4 py-4">
          <nav className="flex items-center justify-center gap-6 flex-wrap">
            ...
            <Link href="/threat-intelligence" className="text-text hover:text-white transition-colors font-medium text-sm">Threat Intelligence</Link>
            ...
            <Link href="/security-benchmark" className="text-white font-medium border-b-2 border-primary pb-0.5 text-sm">Security Benchmark</Link>
